...
# turn = sys.argv[2]
# is_turn = 1
# file_name = "dataset-awgn-turbo-" + str(snr) + "db-pre-raw.csv"
# file_name = "dataset-rayleigh-single-turbo-" + str(snr) + "db-pre-raw.csv"
file_name = "dataset-rayleigh-dual-turbo-" + str(snr) + "db-pre-raw.csv"
