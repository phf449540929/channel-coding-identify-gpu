...
# turn = sys.argv[2]
# is_turn = 1
# file_name = "dataset-awgn-ldpc-" + str(snr) + "db-pre-raw.csv"
# file_name = "dataset-rayleigh-single-ldpc-" + str(snr) + "db-pre-raw.csv"
file_name = "dataset-rayleigh-dual-ldpc-" + str(snr) + "db-pre-raw.csv"
