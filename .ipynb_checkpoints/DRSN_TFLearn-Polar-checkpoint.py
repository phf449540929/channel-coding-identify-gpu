...
# turn = sys.argv[2]
# is_turn = 1
# file_name = "dataset-awgn-polar-" + str(snr) + "db-pre-raw.csv"
# file_name = "dataset-rayleigh-single-polar-" + str(snr) + "db-pre-raw.csv"
file_name = "dataset-rayleigh-dual-polar-" + str(snr) + "db-pre-raw.csv"
